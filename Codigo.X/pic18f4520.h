...
#define BitClr(arg,bit) ((arg) = (arg) & (~(1<<(bit)))) 
...
#define LATCHA	(*(volatile __near unsigned char*)0xF89)
#define LATCHB	(*(volatile __near unsigned char*)0xF8A)
#define LATCHC	(*(volatile __near unsigned char*)0xF8B)
#define LATCHD	(*(volatile __near unsigned char*)0xF8C)
#define LATCHE	(*(volatile __near unsigned char*)0xF8D)
